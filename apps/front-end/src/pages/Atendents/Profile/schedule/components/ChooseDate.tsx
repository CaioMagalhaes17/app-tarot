  ...
  return (
    <>
      <div className="mt-5 flex flex-col items-center gap-10">
        ...
        <div className="bg-[#2f224736] border border-[#323b45] rounded-xl flex flex-col w-[350px]">
          <div className="bg-primary px-3 mb-2" style={{ borderTopLeftRadius: '0.75rem', borderTopRightRadius: '0.75rem' }}>
            <Text className="text-xl text-white font-bold" as='h1'>Escolha um dia</Text>
          </div>
          <div className="p-4">
            <DayPicker
              ...
              classNames={{
                ...
                month_caption: 'capitalize text-xl text-white font-bold text-left',
              }}
            />
          </div>
        </div>
