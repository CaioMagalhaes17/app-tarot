...
export function ChatContactsList({ contacts, setSelectedContact }: { setSelectedContact: React.Dispatch<React.SetStateAction<ContactType | undefined>>, contacts: ContactType[] }) {
  return (
    <Panel className="border border-dark bg-[#131426b3] h-full w-[550px]  rounded-xl flex flex-col p-6 font-bold">
