      ...
      <div className="flex min-h-screen justify-center">
        <div className="flex flex-col font-bold min-w-[70%]">
          <div className="bg-[#1d1232] p-4  border-[#6028dc1a] border-[4px]  rounded-xl">
            <div className="flex max-w-[1100px] ml-auto mr-auto relative flex-row items-center font-bold gap-5">
              ...
              <div className="flex flex-col items-center gap-5">
                <Button className="btn-purple flex w-full flex-row gap-2"><IconMoon />Serviços</Button>
                <Button className="btn-warning  w-full  flex flex-row gap-2"><Star />Avaliações</Button>
                <div className="flex items-center flex-col">
                  <Button className="btn-primary flex flex-row gap-2 w-full w-full"><IconChat /> Chamar no Chat</Button>
          ...
          <div className="bg-[#1d1232] border-[#6028dc1a] border-[4px] p-4 rounded-xl mt-5">
            <div className="max-w-[1100px] flex flex-col ml-auto mr-auto font-bold">
          ...
          <div className="bg-[#1d1232] border-[#6028dc1a] border-[4px] p-4 rounded-xl mt-5 mb-20">
            <div className="max-w-[1100px] flex flex-col ml-auto mr-auto font-bold">
