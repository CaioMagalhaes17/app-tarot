...
export function Login() {
  const { errors, handleSubmit, isMobile, onSubmit, register, searchParams, setUseEmail, useEmail } = useLoginController()
  return (
    <>
      <div className="flex items-center justify-center mt-5">
        <div className="w-full max-w-[570px] rounded-md p-2">
          <div className="flex flex-col justify-center rounded-md  bg-[#2f224736] px-6 py-10">
            <div className="mx-auto scrollable w-full">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-white">
                ...
                {useEmail ? (<div>
                  ...
                  <label className="text-left text-white" htmlFor="Name">Telefone</label>
                  <div className="relative text-white-dark">
