...
export const IconCard: FC<IconSearchProps> = ({ className, fill = false, duotone = true, width, height }) => {
  return (
    <>
      {!fill ? (
        <svg width={width ? width : "20"} height={height ? height : "20"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
          <path
        ...
        <svg width={width ? width : "24"} height={height ? height : "24"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
          <path
