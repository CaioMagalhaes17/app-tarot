...
export const IconPix: FC<IconXProps> = ({ className, width, height, fill = false, duotone = true }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width || '100'} height={height || "100"} className={className} viewBox="0 0 48 48" >
